...
const file_ledger_v1_transaction_proto_rawDesc = "" +
	"\n" +
	"\x1bledger/v1/transaction.proto\x12\tledger.v1\"\xcd\x01\n" +
...
var file_ledger_v1_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_ledger_v1_transaction_proto_depIdxs = []int32{
	4, // 0: ledger.v1.GetTransactionResponse.entries:type_name -> ledger.v1.EntryResponse
